          ...
          <div className="wrapper-clinic">
              ...
              <div className="sort-clinic">
                  <div style={sorActives?{height:'144px'}:{}} className="sort-block-clinic">
                      <div onClick={setSortBlockClinic} style={sorActives?{background:'#1B6B93', border:'#023246 1px solid',borderRadius:'6px 6px 0 0',color:'#c2e2f2'}:{}} className="sort-block__info-clinic">
                      ...
                      <div className={sorActives?"sort-block__choose-clinic":'none'}>
                          <div className="price-clinic">
                              ...
                              <div className="arrows-clinic">
                                  <img onClick={sortPriceU} src={sortByRating==="asc"?arrowSortU:arrowSortUL}/>
                          ...
                          <div className="stage-clinic">
                              по популярности
                              <div className="arrows-clinic">
                                  <img onClick={sortStageUpClinic} src={sortStage==="up"?arrowSortUL:arrowSortU}/>
                                  <img onClick={sortStageDClinic} src={sortStage=="down"?arrowSortDL:arrowSortD}/>
                              </div>
                          </div>
                      </div>
              ...
              {currentPosts.map((e)=><CardClinic data={e}/>)}
