          ...
          <div className={styles.nav}>
            <div className={styles.selects}>
              ...
              <div className={styles.selector}>
                <div className={styles.selectTitle} onClick={languageHandle}>{currentLanguage}<img src={langPopUp?stroke1:stroke}/></div>
                <div className={langPopUp?styles.selectBox:styles.none}>
                  ...
                  <div className={styles.option}>
                    ...
                    <label htmlFor={'kgl'}><p style={currentLanguage==='Кыргызский'?{}:{color:'#023246'}}>Кыргызский</p></label>
                    <input onChange={changeTranslation} id={'rul'} value={'ru'} type={"checkbox"}/>
                    <label htmlFor={'rul'}><p style={currentLanguage==='Русский'?{}:{color:'#023246'}}>Русский</p></label>
                  </div>
                </div>
              </div>

              <div className={styles.selector}>
                <div className={styles.selectTitle} onClick={cityHandle}>{currentCity}<img src={cityModal?stroke1:stroke}/></div>
                <div className={cityModal?styles.selectBox:styles.none}>
                  ...
                  <div className={styles.option}>
                    ...
                    <label htmlFor={'bishkekc'}><p style={currentCity==='Бишкек'?{}:{color:'#023246'}}>Бишкек</p></label>
                    <input onChange={changeLocation} id={'oshc'} value={'osh'} type={"checkbox"}/>
                    <label htmlFor={'oshc'}><p style={currentCity==='Ош'?{}:{color:'#023246'}}>Ош</p></label>
                  </div>
                </div>
              </div>
